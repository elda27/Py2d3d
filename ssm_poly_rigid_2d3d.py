...
def main():
    ...
    for c, image in zip(args.camera, input_images):
        ...
        if not args.ignore_image_informations:
    ...
    for f, f_conf in zip_longest(args.framework, args.framework_conf):
        assert f is None, \
...
def create_parser():
    ...
    parser.add_argument('--framework', type=str, nargs='*', required=False,
                        help='Using framework names for the registration.')
    parser.add_argument('--framework-config', type=str, nargs='*',
                        required=False, help='Configuration files of.'
    ...
    parser.add_argument('--optimizer-params', type=str, nargs='*',
                        required=True, help='Hyper-parameters of optimizer.')
